...
class Op2StrType(UserDict):
    def __init__(self):
        ...
        self[_Op_code.acos] = partial(_call_func, "acos")
        self[_Op_code.acosh] = partial(_call_func, "acosh")
        self[_Op_code.asin] = partial(_call_func, "asin")
        self[_Op_code.asinh] = partial(_call_func, "asinh")
        self[_Op_code.atan] = partial(_call_func, "atan")
        self[_Op_code.atanh] = partial(_call_func, "atanh")
        self[_Op_code.cos] = partial(_call_func, "cos")
        self[_Op_code.cosh] = partial(_call_func, "cosh")
        self[_Op_code.sin] = partial(_call_func, "sin")
        self[_Op_code.sinh] = partial(_call_func, "sinh")
        self[_Op_code.tan] = partial(_call_func, "tan")
        self[_Op_code.tanh] = partial(_call_func, "tanh")
